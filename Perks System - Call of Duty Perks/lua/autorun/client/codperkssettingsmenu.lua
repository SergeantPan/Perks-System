...
spawnmenu.AddToolMenuOption( "Options", "Player Perks", "PerksSettings", "CoD Icons Settings", "", "", function( panel )
	panel:ClearControls()
...
spawnmenu.AddToolMenuOption( "Options", "Player Perks", "Misc", "CoD Perk Settings", "", "", function( panel )
	panel:ClearControls()
	...
	panel:ControlHelp("\nAlternate model settings:")
	panel:CheckBox("Use alternate Scavenger Pack model", "CODPerksScavAltModel")
	panel:Help( "Use a model of your choice over the default ammo pack model. Requires a valid model path." )
	panel:TextEntry("Model Path", "CODPerksScavAltModelPath")

	panel:CheckBox("Use alternate Armorer Pack model", "CODPerksArmorerAltModel")
	panel:Help( "Use a model of your choice over the default armor battery model. Requires a valid model path." )
	panel:TextEntry("Model Path", "CODPerksArmorerAltModelPath")
	...
	panel:Help('If the "Spawn with turret" setting is enabled, only spawn a free turret on the players first spawn.')
