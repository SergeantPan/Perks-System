...
local PerkImage = vgui.Create("DImageButton", panel)
PerkImage:SetPos(10, 150)
PerkImage:SetSize(80,70)
...
local PerkImage = vgui.Create("DImageButton", panel)
PerkImage:SetPos(12, 240)
PerkImage:SetSize(85,70)
